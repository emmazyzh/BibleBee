...
- `VITE_API_BASE_URL`
  - 可选
  - 本地或纯前端部署时可指定 API 基地址
  - Cloudflare Pages 上通常不需要设置为 Vercel 域名，因为 Pages 会优先走同源代理 `/api/*`
...
## 1.6. Cloudflare 代理接口说明

代理文件：

- [`functions/api/[[path]].js`](/Users/yongzhenzhuang/Projects/BibleBee/functions/api/[[path]].js)
